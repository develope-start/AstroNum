...
export default function HomePage() {
  ...
  return (
    <div className="space-y-8 sm:space-y-16">
      ...
      <section className="relative pt-1 text-center sm:pt-4">
        <div className="mx-auto mb-3 inline-flex items-center gap-1.5 sm:gap-2 rounded-full border border-amber-400/30 bg-gradient-to-r from-amber-500/10 via-purple-500/15 to-amber-500/10 px-3.5 py-1 backdrop-blur-xl shadow-sm max-w-full">
          <Stars className="h-3.5 w-3.5 text-amber-300 animate-pulse shrink-0" />
          <span className="text-[0.62rem] sm:text-[0.68rem] font-bold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-amber-300 truncate">
            ✦ შვეიცარიული ეფემერიდი & ასტროლოგიური ანალიზი
          </span>
        </div>

        <h1 className="font-display text-xl font-bold text-slate-100 sm:text-3xl px-2">
