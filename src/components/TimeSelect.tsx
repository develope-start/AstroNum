...
export default function TimeSelect({
  ...
  return (
    <div className="grid grid-cols-2 gap-2.5">
      <div>
        <label className="mb-1 block text-[0.65rem] uppercase tracking-wider font-bold text-slate-300">საათი</label>
        <select
      ...
      <div>
        <label className="mb-1 block text-[0.65rem] uppercase tracking-wider font-bold text-slate-300">წუთი</label>
        <select
          className={selectClass}
          value={minute}
