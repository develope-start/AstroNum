...
export default function Nav() {
  ...
  return (
    <header className="sticky top-0 z-50 px-2 py-2 sm:px-6 sm:py-3 w-full">
      <div className="mx-auto flex max-w-6xl flex-col gap-2 rounded-2xl sm:rounded-full border border-amber-400/30 bg-[#070414]/90 p-2.5 sm:px-6 sm:py-2.5 backdrop-blur-2xl shadow-[0_12px_40px_rgba(0,0,0,0.75)] w-full">
        {/* Top Row: Logo on Left, Cabinet & Profile Actions on Right */}
        <div className="flex items-center justify-between w-full">
          ...
          {/* Right Action: Cabinet & Account Links */}
          <nav className="flex items-center gap-2 sm:gap-3 text-xs font-bold text-slate-200 shrink-0">
            {me === null && (
              <Link
                href="/cabinet"
                className="flex items-center gap-1.5 rounded-full border border-amber-400/40 bg-gradient-to-r from-amber-500/20 via-purple-600/25 to-amber-500/20 px-3.5 py-1.5 sm:px-4 sm:py-2 text-xs font-bold text-amber-300 shadow-[0_0_20px_rgba(245,158,11,0.25)] transition-all hover:scale-105 hover:border-amber-400"
              >
            ...
            {me && (
              <>
                <Link
                  ...
                  className="flex items-center gap-1.5 rounded-full border border-amber-400/30 bg-purple-950/60 px-3 py-1.5 sm:px-3.5 sm:py-2 text-xs font-bold text-amber-300 transition-all hover:bg-amber-400/20"
                >
                ...
                {me.role === "ADMIN" && (
                  <Link
                    href="/admin"
                    className="flex items-center gap-1.5 rounded-full px-2.5 py-1.5 text-amber-400 hover:bg-amber-400/10 hover:text-amber-300"
                  >
        ...
        {/* Bottom Prominent Calculator Bar - Placed Horizontally Below Logo & Cabinet */}
        <div className="pt-1 border-t border-amber-500/20 flex items-center justify-center w-full">
          <Link
            href="/#calculator"
            className="flex w-full sm:w-auto items-center justify-center gap-2 rounded-full bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 px-5 py-2 sm:px-8 sm:py-2 text-xs sm:text-sm font-extrabold text-slate-950 shadow-[0_0_25px_rgba(245,158,11,0.45)] transition-all hover:scale-[1.02] hover:shadow-[0_0_35px_rgba(245,158,11,0.65)]"
          >
            <Compass className="h-4 w-4 text-slate-950 animate-pulse shrink-0" />
