...
export default function AdminCalculationViewer({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
      <div className="max-h-[92vh] w-full max-w-5xl overflow-y-auto rounded-2xl border border-slate-400/50 bg-[#0d0a18] p-5 shadow-[0_0_35px_rgba(148,163,184,0.28)] sm:p-8">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-500/30 pb-4">
          ...
          <button type="button" onClick={onClose} className="rounded-full border border-slate-400/60 px-4 py-2 text-sm font-bold text-slate-200 transition hover:border-slate-200 hover:bg-slate-400/20">
            დახურვა
          </button>
        </div>
